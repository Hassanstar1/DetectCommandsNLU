...
def callme():
 ...
 if basicTree is None:
     ...
     ment6.set("Do you want to do the following?" + ment.get() + " if you argree say yes or ok ")
     stt3()
...
def yousaid():
    tts = gTTS(text=ment6.get(), lang='en', slow=False)
    tts.save("hh2.mp3")
    file="hh2.mp3"
    pygame.init()
    pygame.mixer.init()
...
def GenGui():
    ...
    ment.set("send to dad content go home")
