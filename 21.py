...
sentences =["send a message to dad",
            ...
            "send to dad                                    content take your medication",
            ...
            "send an sms at 9 am content good morning to my dad your office",
...
Command -> TEXT0 CommandSlots | CommandSlots
...
def parse_maverick_command(command,i):
    ...
    local_maverick_productions.extend([literal_production("WORD0", word) for word in words if word not in kewords])
    local_maverick_productions.extend([literal_production("NUMBER0", number) for number in numbers])
    local_maverick_productions.extend([literal_production("WORD2", word) for word in words if word not in kewords])
    local_maverick_productions.extend([literal_production("NUMBER2", number) for number in numbers])
    local_maverick_productions.extend([literal_production("WORD3", word) for word in words])
    local_maverick_productions.extend([literal_production("NUMBER3", number) for number in numbers])
    local_maverick_productions.extend([literal_production("WORD4", word) for word in words])
